...
def notification(message):
    try:
                ...
                <tr>
                  <td align="center" valign="top" id="bodyCell" style='-webkit-text-size-adjust: 100%;-ms-text-size-adjust: 100%;mso-table-lspace: 0pt;mso-table-rspace: 0pt;margin: 0;padding: 20px;font-family: "ProximaNova", sans-serif;height: 100% !important;'>
                    <div class="main">
                      ...
                      <p>Here is your Download ID: {mp3_fid}. Please click the following link to download your file:</p>
                      <p><a href="https://clipsify.net/download?fileId={mp3_fid}">Download MP3</a></p>
                      <br />
                      Thanks!
                      <br />
        ...
        # Construct the mail message content with HTML
        mail_message = {
